"""LLM vendor utilities for API key management."""
...
def set_api_key_for_vendor(vendor: str, api_key: str) -> None:
    ...
    This function sets the correct environment variable based on the AI provider
    being used, ensuring compatibility with pydantic-ai's model initialization.
    ...
    Example:
        ```python
        from pygentic_ai.utils import set_api_key_for_vendor

        set_api_key_for_vendor("openai", "sk-...")
        set_api_key_for_vendor("anthropic", "sk-ant-...")
        ```
    """
